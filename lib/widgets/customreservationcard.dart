...
import 'package:plusofroad/widgets/customStepper.dart';
          ...
          Row(
            children: [
              Column(
                ...
                children: [
                  Text("Hotel name"),
                  Text("ID #11226Tr", style: TextStyle(color: AppColors.grey)),
                ],
              ),
              Expanded(child: SizedBox()),
              Text('Show Details', style: TextStyle(color: AppColors.main)),
            ],
          ),
          Container(
            margin: EdgeInsets.symmetric(vertical: 4.sp),
            alignment: Alignment.center,
            child: CutomStepper(steps: step),
          ),
          Divider(color: AppColors.greyfat.withOpacity(0.6), thickness: 3.sp),
          Row(
            children: [
              Container(
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Hotel name', style: TextStyle(color: AppColors.main)),
                  RichText(
                    text: TextSpan(
                      text: 'From ',
                  ...
                  Text('3 Nights', style: AppTextStyle.greysmall),
                  Text('4 rsooms', style: TextStyle(color: AppColors.grey)),
                  step == 2
                      ? Text(
                        'Status : requested',
            ...
            children: [
              step == 2
                  ? Container(
                    ...
                    child: Text(r"200$", style: TextStyle(color: Colors.white)),
                  )
                  : step == 3
                  ? Container(
                    margin: EdgeInsets.symmetric(horizontal: 5.sp),
