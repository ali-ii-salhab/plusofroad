...
import 'package:plusofroad/data/datasource/remote/auth/login_data.dart';
import 'package:plusofroad/main.dart';
  ...
  Future<void> activateAccount(BuildContext context) async {
    ...
    if (response['statuscode'] == 204) {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text("Failed to activate account.")));
      Get.offNamed(AppRoutes.signup);
    }
  }
