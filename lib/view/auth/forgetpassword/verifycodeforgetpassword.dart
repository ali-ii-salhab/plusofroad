import 'package:plusofroad/controller/auth/verifycodecontroller.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          ...
          style: Theme.of(
            context,
          ).textTheme.displayLarge!.copyWith(color: AppColors.black),
        ),
      ),
                    ...
                    onSubmit: (String code) async {
                      {
                        print(code);
                        print("dfdfdfdf");
                        var status = await controller.getverifycodestatus(code);
                        ...
                        if (Get.previousRoute == "/forgetpassword") {
                          if (status.toString() == "true") {
                            Get.offAllNamed(
                              ...
                              arguments: {"email": controller.email.toString()},
                            );
                          } else {
                            Get.snackbar("error", "wrong verify code");
                          }
